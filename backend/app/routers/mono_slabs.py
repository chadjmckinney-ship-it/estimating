...
def _to_read(db: Session, row: MonoSlab, rates: tuple | None = None) -> MonoSlabRead:
    ...
    return MonoSlabRead(
        ...
        # Sidewalk drivers (sql/076)
        stamped=row.stamped,
        integral_color=row.integral_color,
        acid_etch=row.acid_etch,
        stair_tread_lf=row.stair_tread_lf,
        stair_tread_rise_in=row.stair_tread_rise_in,
        ...
        calc_stair_concrete_cy=row.calc_stair_concrete_cy,
        calc_edge_rebar_lb=row.calc_edge_rebar_lb,
...
def create_mono_slab(body: MonoSlabCreate, db: Session = Depends(get_db)) -> MonoSlabRead:
    ...
    row = MonoSlab(
        ...
        integral_color=body.integral_color,
        acid_etch=body.acid_etch,
        stair_tread_lf=body.stair_tread_lf,
        stair_tread_rise_in=body.stair_tread_rise_in,
